...
/**
 * Makes usage of the avconv-tool (ffmpeg) and extracts the current snapshot
 * from the HiKam S3 as configured in the properties.
 * 
 * @author Vanmodeus
 *
 */
public class OnvifExtractor {
	...
	public boolean extractPicture() {
		try {
			...
			// Prepend OS-Code for Command-Prompt / Shell / Console / etc., you
			// know what i mean
			...
			// Fancy falls notwendig, aber egal weil immer der Fehler bei der
			// scheiß HiKam kumt -> Also FileCheck
